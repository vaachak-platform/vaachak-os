...
use crate::vaachak_x4::runtime::state_io_guarded_write_backend_adapter_shape::{
    phase38o_live_mutation_still_disabled, Phase38oAdapterDecision, Phase38oAdapterPlan,
    Phase38oAdapterOperation, PHASE_38O_BACKEND_BOUND, PHASE_38O_LIVE_MUTATION_ENABLED,
};
...
pub const fn phase38p_next_lane_for_status(
    status: Phase38pAcceptanceStatus,
) -> Phase38pNextLane {
    match status {
