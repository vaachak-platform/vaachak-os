...
use crate::vaachak_x4::x4_kernel::ui::{free_stack_bytes, stack_high_water_mark};
...
impl super::Kernel {
    ...
    fn wait_for_power_button_release_before_sleep(&mut self) {
        ...
        if crate::vaachak_x4::x4_kernel::board::power_button_is_low() {
            log::info!("sleep: waiting for power button release before deep sleep");
        }

        while crate::vaachak_x4::x4_kernel::board::power_button_is_low() {
    ...
    fn sd_card_sleep(&self) {
        ...
        critical_section::with(|cs| {
            let bus_ref = crate::vaachak_x4::x4_kernel::board::SPI_BUS_REF
                .borrow(cs)
                .get();
            let mut cs_pin = crate::vaachak_x4::x4_kernel::board::SD_CS_SLEEP.borrow_ref_mut(cs);
