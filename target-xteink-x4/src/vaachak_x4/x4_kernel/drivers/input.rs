...
use crate::vaachak_x4::x4_kernel::board::InputHw;
use crate::vaachak_x4::x4_kernel::board::button::{
    Button, ROW1_THRESHOLDS, ROW2_THRESHOLDS, decode_ladder,
};
use crate::vaachak_x4::x4_kernel::kernel::timing;
...
impl InputDriver {
    ...
    fn read_raw(&mut self) -> Option<Button> {
        let power_low = crate::vaachak_x4::x4_kernel::board::power_button_is_low();
        if power_low {
