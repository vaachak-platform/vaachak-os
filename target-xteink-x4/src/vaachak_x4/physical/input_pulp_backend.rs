...
/// Pulp compatibility backend metadata for the Vaachak input runtime owner.
///
...
pub struct VaachakInputPulpBackend;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct VaachakInputPulpBackendReport {
...
impl VaachakInputPulpBackendReport {
    pub const fn bridge_ok(self) -> bool {
        self.active_hardware_executor
            && self.active_adc_executor_owner.len()
                == VaachakInputPulpBackend::ACTIVE_ADC_EXECUTOR_OWNER.len()
            && self.active_button_scan_executor_owner.len()
                == VaachakInputPulpBackend::ACTIVE_BUTTON_SCAN_EXECUTOR_OWNER.len()
            && self.active_debounce_executor_owner.len()
                == VaachakInputPulpBackend::ACTIVE_DEBOUNCE_EXECUTOR_OWNER.len()
            && self.active_navigation_executor_owner.len()
                == VaachakInputPulpBackend::ACTIVE_NAVIGATION_EXECUTOR_OWNER.len()
...
impl VaachakInputPulpBackend {
    pub const BACKEND_NAME: &'static str = "PulpCompatibility";
    pub const ACTIVE_HARDWARE_EXECUTOR: bool = true;

    pub const ACTIVE_ADC_EXECUTOR_OWNER: &'static str = "vendor/pulp-os imported runtime";
    pub const ACTIVE_BUTTON_SCAN_EXECUTOR_OWNER: &'static str = "vendor/pulp-os imported runtime";
    pub const ACTIVE_DEBOUNCE_EXECUTOR_OWNER: &'static str = "vendor/pulp-os imported runtime";
    pub const ACTIVE_REPEAT_EXECUTOR_OWNER: &'static str = "vendor/pulp-os imported runtime";
    pub const ACTIVE_NAVIGATION_EXECUTOR_OWNER: &'static str = "vendor/pulp-os imported runtime";
    pub const ACTIVE_SHELL_INPUT_EXECUTOR_OWNER: &'static str = "vendor/pulp-os imported runtime";
    ...
    pub const fn report() -> VaachakInputPulpBackendReport {
        VaachakInputPulpBackendReport {
