...
pub use crate::vaachak_x4::x4_kernel::util::decode_utf8_char;

use crate::vaachak_x4::x4_apps::apps::PendingSetting;
use crate::vaachak_x4::x4_apps::fonts::bitmap::{self, BitmapFont};
...
use crate::vaachak_x4::x4_kernel::kernel::work_queue::DecodedImage;
use smol_epub::cache;
...
impl App<AppId> for ReaderApp {
    ...
    fn pending_setting(&self) -> Option<PendingSetting> {
        Some(PendingSetting::ReaderPreferences(
            crate::vaachak_x4::x4_kernel::kernel::config::ReaderPreferences {
