...
impl ReaderApp {
    ...
    fn scan_chapter_for_image(
        ...
        ch: usize,
        start_offset: usize,
    ) -> crate::vaachak_x4::x4_kernel::error::Result<ScanResult> {
    ...
    pub(super) fn epub_recv_image_result(
        &mut self,
        k: &mut KernelHandle<'_>,
    ) -> crate::vaachak_x4::x4_kernel::error::Result<Option<bool>> {
...
pub(super) fn decode_image_streaming(
    ...
    max_w: u16,
    max_h: u16,
) -> crate::vaachak_x4::x4_kernel::error::Result<DecodedImage> {
    let mut hdr = [0u8; 30];
...
fn peek_source_dimensions(
    ...
    let read_err =
        |_: crate::vaachak_x4::x4_kernel::error::Error| -> &'static str { "read failed" };
