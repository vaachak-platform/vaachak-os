...
exists scripts/revert_phase35_storage_state_io_seam.sh
...
contains "Phase 35 documents no imported runtime call-site wiring" \
  'No imported runtime call site|not wired|manual decision' \
  docs/phase35
