...
expected="/tmp/phase22_expected_runtime.rs"
actual="/tmp/phase22_actual_runtime.rs"
diff_file="/tmp/phase22_reader_runtime_sync.diff"
...
drop_contains = [
    ...
    'VaachakOS Phase 16', 'VaachakOS Phase 17', 'VaachakOS Phase 18',
    'VaachakOS Phase 19', 'VaachakOS Phase 20', 'VaachakOS Phase 21', 'VaachakOS Phase 22',
    'VaachakRuntime::emit_boot_marker',
    'VaachakDisplayBoundary::emit_boot_marker',
    'VaachakStorageBoundary::emit_boot_marker',
    'VaachakInputBoundary::emit_boot_marker',
    'crate::runtime::vaachak_runtime::VaachakRuntime::emit_boot_marker',
    'crate::runtime::display_boundary::VaachakDisplayBoundary::emit_boot_marker',
    'crate::runtime::storage_boundary::VaachakStorageBoundary::emit_boot_marker',
    'crate::runtime::input_boundary::VaachakInputBoundary::emit_boot_marker',
]
out = []
for line in lines:
...
if diff -u "$expected" "$actual" > "$diff_file"; then
  echo "OK   Phase 22 imported runtime matches vendored Pulp main after allowed Vaachak marker normalization"
  exit 0
fi

echo "FAIL Phase 22 imported runtime drift detected beyond allowed Vaachak marker normalization"
