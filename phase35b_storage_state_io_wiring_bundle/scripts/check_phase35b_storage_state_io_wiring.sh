...
if [[ "${PHASE35B_RUN_CARGO:-0}" == "1" ]]; then
  ...
  ok "cargo metadata/check/clippy passed inside script"
else
  ok "cargo validation skipped inside script; set PHASE35B_RUN_CARGO=1 to enable"
fi
