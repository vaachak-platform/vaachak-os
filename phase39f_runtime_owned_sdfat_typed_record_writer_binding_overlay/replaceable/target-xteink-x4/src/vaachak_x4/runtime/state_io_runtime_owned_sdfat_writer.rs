...
use crate::vaachak_x4::runtime::state_io_typed_record_sdfat_adapter::{
    phase39e_execute_with_sdfat_adapter, Phase39eBackendError, Phase39eSdFatAdapterConfig,
    Phase39eSdFatAdapterReport, Phase39eSdFatBackendResult, Phase39eSdFatLikeBackend,
    Phase39eSdFatWriteCommand,
};
    ...
    for Phase39fRuntimeOwnedSdFatBackend<'_, O>
{
    ...
    fn write_atomic(
        ...
        self.write_calls = self.write_calls.saturating_add(1);
        self.record_result(self.ops.write_record_atomic(
...
impl Phase39fRuntimeOwnedWriterReport {
    pub const fn committed(self) -> bool {
        matches!(self.status, Phase39fRuntimeWriterStatus::RuntimeWriteCommitted)
    }
}
...
fn path_from_slice(path: &[u8]) -> Phase39dTypedRecordPath {
    let mut bytes = [0u8; crate::vaachak_x4::runtime::state_io_typed_record_write_lane::PHASE_39D_MAX_RECORD_PATH_LEN];
