...
pub const SLEEP_IMAGE_CACHE_HINT_FILE: SleepBitmapCandidate = SleepBitmapCandidate::root("SLPCACHE.TXT");
...
pub fn parse_sleep_image_mode(data: &[u8]) -> Option<SleepImageMode> {
    ...
    } else if eq_ascii(s, b"off") || eq_ascii(s, b"none") || eq_ascii(s, b"no-redraw") || eq_ascii(s, b"no_redraw") {
