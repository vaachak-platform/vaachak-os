...
impl Phase39jVerificationSignal {
    pub const fn present(self) -> bool {
        matches!(self, Self::PresentEmpty | Self::PresentNonEmpty | Self::RestoredByReader)
    }
...
impl Phase39jRuntimeStateWriteVerificationReport {
    ...
    pub fn next_lane(self) -> Phase39jNextLane {
        match self.acceptance() {
            Phase39jPersistenceAcceptance::Accepted => Phase39jNextLane::CleanupWriteLaneScaffolding,
