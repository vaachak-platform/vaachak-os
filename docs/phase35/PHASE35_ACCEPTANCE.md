...
## Storage State IO Seam Acceptance

Phase 35 accepts a scaffolded seam, not a physical storage extraction.

```text
- Vaachak-owned trait and adapter scaffolding exist.
- The seam uses Vaachak storage path helpers.
- Progress, Bookmark, Theme, and Metadata are represented.
- Physical SD/SPI/FAT IO remains imported-runtime-owned.
