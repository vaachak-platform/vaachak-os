...
use crate::vaachak_x4::runtime::state_io_runtime_file_api_integration_gate::{
    Phase39gIntegrationGateDecision, Phase39gIntegrationGateReport, Phase39gIntegrationRequest,
    Phase39gRuntimeFileApiCandidate, Phase39gRuntimeFileApiProbe,
...
impl Phase39hRuntimeWriteEnablement {
    ...
    pub const fn probe(
        self,
        candidate: Phase39gRuntimeFileApiCandidate,
...
pub fn phase39h_write_all_typed_state<O: Phase39fRuntimeOwnedFileOps>(
    ...
    let reports = [
        ...
        phase39h_append_bookmark_index(ops, payloads.bookmark_index_payload, enablement, config),
    ];
