...
use crate::vaachak_x4::runtime::state_io_progress_write_backend_binding::{
    phase39a_execute_progress_write, Phase39aBackendWriteResult,
    ...
    Phase39aProgressWriteRequest, PHASE_39A_PROGRESS_WRITE_ONLY, PHASE_39A_WRITE_LANE_STARTED,
};
...
pub const fn phase39b_outcome_from_phase39a(
    ...
    match phase39a_report.outcome {
        ...
        Phase39aProgressWriteOutcome::WriteRejected => Phase39bCallbackBackendOutcome::WriteRejected,
        Phase39aProgressWriteOutcome::BackendUnavailable => {
            Phase39bCallbackBackendOutcome::BackendUnavailable
        }
        Phase39aProgressWriteOutcome::InvalidRequest => Phase39bCallbackBackendOutcome::InvalidRequest,
    }
}
