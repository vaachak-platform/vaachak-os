...
impl VaachakActiveInputSemanticMapper {
    ...
    pub fn map_event(swap: bool, event: ImportedInputEvent) -> ImportedActionEvent {
        match event {
            ImportedInputEvent::Press(button) => ImportedActionEvent::Press(Self::map_button(swap, button)),
    ...
    fn imported_default_mapping_matches_vaachak() -> bool {
        ...
        !mapper.is_swapped()
            && mapper.map_button(ImportedButton::VolDown) == Self::map_button_default(ImportedButton::VolDown)
            && mapper.map_button(ImportedButton::VolUp) == Self::map_button_default(ImportedButton::VolUp)
            && mapper.map_button(ImportedButton::Right) == Self::map_button_default(ImportedButton::Right)
            && mapper.map_button(ImportedButton::Left) == Self::map_button_default(ImportedButton::Left)
            && mapper.map_button(ImportedButton::Confirm) == Self::map_button_default(ImportedButton::Confirm)
            && mapper.map_button(ImportedButton::Back) == Self::map_button_default(ImportedButton::Back)
            && mapper.map_button(ImportedButton::Power) == Self::map_button_default(ImportedButton::Power)
    }
    ...
    fn imported_swapped_mapping_matches_vaachak() -> bool {
        ...
        mapper.is_swapped()
            && mapper.map_button(ImportedButton::VolDown) == Self::map_button_swapped(ImportedButton::VolDown)
            && mapper.map_button(ImportedButton::VolUp) == Self::map_button_swapped(ImportedButton::VolUp)
            && mapper.map_button(ImportedButton::Right) == Self::map_button_swapped(ImportedButton::Right)
            && mapper.map_button(ImportedButton::Left) == Self::map_button_swapped(ImportedButton::Left)
            && mapper.map_button(ImportedButton::Confirm) == Self::map_button_swapped(ImportedButton::Confirm)
            && mapper.map_button(ImportedButton::Back) == Self::map_button_swapped(ImportedButton::Back)
            && mapper.map_button(ImportedButton::Power) == Self::map_button_swapped(ImportedButton::Power)
    }
...
#[cfg(test)]
mod tests {
    use super::{ImportedAction, ImportedButton, ImportedInputEvent, VaachakActiveInputSemanticMapper};
