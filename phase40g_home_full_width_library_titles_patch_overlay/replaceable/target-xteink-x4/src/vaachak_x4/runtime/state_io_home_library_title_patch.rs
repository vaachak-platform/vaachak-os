...
pub enum Phase40gPatchStatus { Accepted, Blocked }

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum Phase40gPatchReason { HomeAndLibraryTitlesFixed, ProtectedSurfaceTouched, DeviceConfirmationMissing }

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum Phase40gNextLane { DeviceRegression, RepairTitlePatch }
...
pub fn phase40g_marker() -> &'static str { PHASE_40G_HOME_LIBRARY_TITLE_PATCH_MARKER }
