...
use crate::vaachak_x4::runtime::state_io_typed_record_write_lane::{
    Phase39dBackendWriteResult, Phase39dBackendWriteStatus, Phase39dBookId,
    ...
    Phase39dTypedWritePreflight, Phase39dTypedWriteReport, Phase39dTypedWriteRequest,
    PHASE_39D_MAX_RECORD_PAYLOAD_LEN,
};
...
pub fn phase39e_execute_with_sdfat_adapter<B: Phase39eSdFatLikeBackend>(
    ...
    let target_path = request.path().unwrap_or_else(Phase39dTypedRecordPath::empty);
